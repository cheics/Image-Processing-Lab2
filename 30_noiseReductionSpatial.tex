...
The sharp peaks seen in the 7x7 averaging filter histogram are less pronounced in the Gaussian filter. 
...
They all result in blurrier images which have a higher PSNR. The blurring occurs because they both supress high frequency components
